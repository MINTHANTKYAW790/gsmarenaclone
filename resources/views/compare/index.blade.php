        ...
        <div class="row mb-2">
            ...
            <div id="device-selector-left" class="col-md-6 mb-3">
                <div class="row">
                    ...
                    <div class="col-sm-4 d-flex align-items-end">
                        <button onclick="loadDeviceDetailLeft()" class="btn btn-secondary w-100">Load</button>
                    </div>
                </div>
            </div>
            ...
            <div id="device-selector-right" class="col-md-6 mb-3">
                <div class="row">
                    ...
                    <!-- Load Button -->
                    <div class="col-sm-4 d-flex align-items-end">
                        <button onclick="loadDeviceDetailRight()" class="btn btn-secondary w-100">Load</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="comparison-table" cellpadding="8" style=" width:100%;">
                <thead>
                    <tr>
                        ...
                        <th>
                            ${left?.name || 'N/A'}<br>
                            ${left?.image_url ? `<img src="/images/${left.image_url.split('/').pop()}" style="max-height: 80px; margin: 6px 0;" alt="${left.name}">` : ''}
                            ${left?.price ? `<div style="color:green;">$${left.price}</div>` : ''}
                        </th>
                        <th>
                            ${right?.name || 'N/A'}<br>
                            ${right?.image_url ? `<img src="/images/${right.image_url.split('/').pop()}" style="max-height: 80px; margin: 6px 0;" alt="${right.name}">` : ''}
